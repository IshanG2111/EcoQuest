...
var ShaderMount = class {
  ...
  setupUniforms = () => {
    ...
    Object.entries(this.providedUniforms).forEach(([key, value]) => {
      ...
      if (typeof Image !== 'undefined' && value instanceof HTMLImageElement) {
    ...
    Object.entries(updatedUniforms).forEach(([key, value]: [string, any]) => {
      ...
      if (typeof Image !== 'undefined' && value instanceof HTMLImageElement) {
        ...
        if (value[0] !== void 0 && Array.isArray(value[0])) {
          ...
          if (value.every((arr: any) => arr.length === firstChildLength)) {
...
var fallbackColor: [number, number, number, number] = [0, 0, 0, 1];
...
async function processUniforms(uniformsProp: any) {
  ...
  Object.entries(uniformsProp).forEach(([key, value]) => {
    ...
    } else if (typeof Image !== 'undefined' && value instanceof HTMLImageElement) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0" style={{ color: layout.inkColor }}>
        <div
          className="absolute whitespace-pre uppercase font-mono font-bold"
          style={{
        ...
        <div
          className="absolute font-bold uppercase font-headline"
          style={{
            left: layout.padding * width,
        ...
        <div
          className="absolute whitespace-nowrap uppercase font-mono font-semibold"
          style={{
            left: layout.padding * width,
...
function TiltCard({
  ...
  const onMove = React2.useCallback(
    (e: React2.PointerEvent<HTMLDivElement>) => {
